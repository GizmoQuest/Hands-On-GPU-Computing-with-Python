...
sudo apt install git cmake clang-6.0 libclang-6.0-dev libclangperl libclanlib-dev libclang-dev zlib1g-dev
cd /opt/
...
echo 'alias hipify=/opt/HIP/hipify-clang/dist/bin/./hipify-clang' >> ~/.bashrc
